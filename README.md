...
```text
PORT=8080
CORS_ALLOWED_ORIGINS=http://tm-kolkata.org,https://tm-kolkata.org,https://somalrudra.github.io,http://localhost:3000,http://localhost:4173
FRONTEND_RESET_URL=http://tm-kolkata.org/analyticFunnel/reset-password/
